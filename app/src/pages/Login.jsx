      ...
      <div className="max-w-2xl bg-white shadow-2xl p-4 mx-auto mt-10 pb-10">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="relative z-0 mb-6 w-full group">
            <input type="email" name="email" id="email" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300  focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " />
          ...
          <div className="relative flex  flex-col mt-20  justify-center">
            <button className="bg-blue-700 w-max mx-auto text-white font-semibold from-slate-50 to-blue-100 px-10 py-2 rounded-2xl shadow-blue-400 shadow-md border-b-4 hover border-b border-blue-400 hover:shadow-sm transition-all duration-500">Signin</button>
          </div>
          {server_error.non_field_errors ? <Alert severity='error'>{server_error.non_field_errors[0]}</Alert> : ""}
        </form>
      </div>
      <section className="max-w-4xl p-6 mx-auto bg-gray-900 rounded-md shadow-md dark:bg-gray-800 mt-20">
