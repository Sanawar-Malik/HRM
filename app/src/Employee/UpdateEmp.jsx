...
const UpdateEmp = ({ setUpdateModal, id }) => {
  ...
  return (
    <>
      <div className="flex  overflow-x-hidden h-[700px] overflow-y-auto fixed  inset-0 z-50 bg-black bg-opacity-20 outline-none focus:outline-none">
            ...
            <div className="relative p-6 mt-4 flex-auto h-[500px] overflow-auto">
              <form onSubmit={handleSubmit}>
                ...
                <div className="grid xl:grid-cols-2 xl:gap-6">
                  ...
                  <div className="flex mb-8">
                    <label className='relative cursor-pointer  bg-white w-full'>
                      <select type="text" name="gender" placeholder="Gender" value={gender} onChange={e => setgender(e.target.value)} className='h-12 w-full   px-6 text-gray-500 border-gray-300 border-2 rounded-lg border-opacity-50 outline-none focus:border-fuchsia-600 placeholder-gray-800 placeholder-opacity-0 transition duration-200' required >
                ...
                <div className="grid xl:grid-cols-2 xl:gap-6">
                  ...
                  <div className="flex mb-8">
                    <label className='relative cursor-pointer w-full'>
                      <input type="text" name="department" id="department" value={department} placeholder='Department' onChange={e => setDepartment(e.target.value)} className='h-12 w-full   px-6 text-gray-500 border-gray-300 border-2 rounded-lg border-opacity-50 outline-none focus:border-fuchsia-600 placeholder-gray-800 placeholder-opacity-0 transition duration-200' />
