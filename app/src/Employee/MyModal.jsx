            ...
            <div className="relative p-6 mt-2 flex-auto h-[500px] overflow-auto">
              <form onSubmit={handleSubmit}>
                ...
                <div className="grid xl:grid-cols-2 xl:gap-6">
                  ...
                  <div className="flex mb-8">
                    <label className='relative cursor-pointer  bg-white w-full'>
                      <select type="text" name="gender" placeholder="Gender" onChange={e => setgender(e.target.value)} className='h-12 w-full   px-6 text-gray-500 border-gray-300 border-2 rounded-lg border-opacity-50 outline-none focus:border-fuchsia-600 placeholder-gray-800 placeholder-opacity-0 transition duration-200' required >
                ...
                <div className="grid xl:grid-cols-2 xl:gap-6">
                  ...
                  <div className="flex mb-8">
                    <label className='relative cursor-pointer w-full'>
                      <input type="text" name="department" id="department" placeholder='Department' onChange={e => setDepartment(e.target.value)} className='h-12 w-full   px-6 text-gray-500 border-gray-300 border-2 rounded-lg border-opacity-50 outline-none focus:border-fuchsia-600 placeholder-gray-800 placeholder-opacity-0 transition duration-200' />
                ...
                <div className="flex mb-8">
                  <label className='relative cursor-pointer w-full'>
                    <input type="text" name="date_of_birth" id="date_of_birth" placeholder='Date of birth' onChange={e => setdateofbirth(e.target.value)} className='h-12 w-full   px-6 text-gray-500 border-gray-300 border-2 rounded-lg border-opacity-50 outline-none focus:border-fuchsia-600 placeholder-gray-800 placeholder-opacity-0 transition duration-200' required />
